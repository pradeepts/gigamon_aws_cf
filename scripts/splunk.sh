#!/bin/bash
wget https://aztdrepo.blob.core.windows.net/gigamon/splunk-stream_711.tgz
tar -xvzf splunk-stream_711.tgz
sudo cp -r ./splunk_app_stream/ /opt/splunk/etc/apps/
wget https://aztdrepo.blob.core.windows.net/gigamon/gigamon-ipfix-metadata-application-for-splunk_110.tgz
...
curl -k -X "POST" -u admin:Splunk@123 https://localhost:8089/servicesNS/admin/splunk_httpinput/data/inputs/http/http/enable
